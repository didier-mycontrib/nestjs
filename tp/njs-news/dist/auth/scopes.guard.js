...
const rolesOrScope_decorator_1 = require("./rolesOrScope.decorator");
let ScopesGuard = class ScopesGuard {
    constructor(reflector) {
        this.reflector = reflector;
    }
    canActivate(context) {
        const requiredScopes = this.reflector.getAllAndOverride(rolesOrScope_decorator_1.HAS_SCOPE_KEY, [
            context.getHandler(),
            context.getClass(),
        ]);
