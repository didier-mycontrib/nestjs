...
exports.NewsModule = NewsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: "News", schema: news_entity_1.NewsSchema }]),
        ],
        controllers: [news_controller_1.NewsController],
        providers: [news_service_1.NewsService, news_mapper_profile_1.NewsMapperProfile],
    })
], NewsModule);
